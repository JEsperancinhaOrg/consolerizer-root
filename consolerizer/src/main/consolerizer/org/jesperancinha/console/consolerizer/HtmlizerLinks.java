...
public class HtmlizerLinks {
    ...
    public static String getYouTubeLink(final String reference) {
        return String.format(YOUTUBE_FRAME,560, 315, reference);
    }
    public static String getYouTubeLink(final String reference, final long width, final long height) {

# consolerizer-spring-boot-tester

## Endpoints

-  [http://localhost:8081](http://localhost:8081) -> Test for Java 11 and above
-  [http://localhost:8081/java8](http://localhost:8081/java8) -> Test for Java 8
